...
const Cards = () => {
  ...
  return (
    <Stack height={'100%'} my={'20px !important'}>
      <Box maxW={{md: '332px',lg:"261px", xl: '384px'}} borderWidth="1px" borderRadius="4px" overflow="hidden" minHeight={{base: '399px' ,md: '421px',lg: '436px',xl:"470px"}} bgColor={'#FFFFFF'} boxShadow={'0px 40px 30px rgba(163, 179, 194, 0.08), 0px 25px 20px rgba(163, 179, 194, 0.06), 0px 10px 8px rgba(163, 179, 194, 0.05)'}>
