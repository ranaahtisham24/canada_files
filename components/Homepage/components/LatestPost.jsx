...
const LatestPost = () => {
  return (
    <Stack width={'100%'} backgroundColor={'#FFFFFF'} direction={{base: 'column',md: 'column',lg:'row', xl: 'row'}} borderRadius={'4px'}>
        ...
        <Stack width={{md: '100%',lg:'38%'}} direction={'column'}  height={'100%'} p={6} pt={{lg: 6,xl:16}} marginLeft={'0 !important'} justifyContent={'center'} alignItems={'flex-start'} spacing={{md: 6,lg: 4,xl:8}}>
