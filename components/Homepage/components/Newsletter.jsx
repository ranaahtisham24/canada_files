...
const Newsletter = () => {
  return (
    <Stack direction={'column'} width={'100%'} alignItems={'center'} spacing={{base: 6,md:12}} bgColor={'#F9FAFB'} px={{base: 6,md:10}} py={{base: 16,md: 20, lg: 24,xl:28}} marginTop={'0 !important'} boxShadow={'0px -6px 8px rgba(163, 179, 194, 0.1)'}>
        ...
        <Stack direction={'column'} width={{base: '100%',md: '80%',lg: '60%',xl:'50%'}} alignItems={{base: 'center' ,md:'flex-start'}}>
            <Stack direction={{base: 'column', md: 'row'}} width={'100%'} spacing={3}>
                <Input width={'100%'} placeholder='Your email address' _placeholder={{color: '#6B7280'}} fontFamily={'Inter'} bgColor={'#FFFFFF'} border={'2px solid #E0E5E8'} boxShadow={'inset 2px 4px 4px rgba(8, 63, 77, 0.1)'} borderRadius={'6px'} />
