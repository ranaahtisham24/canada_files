...
const Supporter = () => {
  return (
    <Stack width={'100%'} my={'16px !important'} direction={'column'} alignItems={'center'} justifyContent={'center'} bgColor={'#F9FAFB'} boxShadow={'0px 40px 30px rgba(163, 179, 194, 0.08), 0px 25px 20px rgba(163, 179, 194, 0.06), 0px 10px 8px rgba(163, 179, 194, 0.05)'} borderRadius={'4px'} spacing={{base: 6,md: 12,xl:16}} px={10} py={{base: 10,md: 12,xl:16}}>
