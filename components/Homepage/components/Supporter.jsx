...
const Supporter = () => {
  return (
    <Stack width={'100%'} direction={'column'} alignItems={'center'} justifyContent={'center'} height={'502px'} bgColor={'#F9FAFB'} boxShadow={'0px 40px 30px rgba(163, 179, 194, 0.08), 0px 25px 20px rgba(163, 179, 194, 0.06), 0px 10px 8px rgba(163, 179, 194, 0.05)'} borderRadius={'4px'} spacing={16} px={10} py={16}>
        <Heading fontFamily={'Merriweather'} fontWeight={'700'} fontSize={'40px'} width={'100%'} textAlign={'center'} fontStyle={'italic'} color={'#22224A'}>Become a Supporter</Heading>
        <Stack fontFamily={'Inter'} fontSize={'20px'} color={'#273848'} lineHeight={'140%'} px={36} spacing={6}>
